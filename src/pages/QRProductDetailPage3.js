...
import chungnhan from '../assets/nguongoc/sp3/chungnhan.png';
      ...
      >
        ...
        >
          ...
          <Box sx={{ width: 'max-content' }}>
            ...
            >
              <SplitText
                text="Thông tin nông trại: Hợp Tác Xã Nông Nghiệp Hoa Sơn"
                delay={50}
                duration={0.6}
                ease="ease-out"
                splitType="chars"
          ...
          <Box sx={{ width: 'max-content' }}>
            ...
            >
              <SplitText
                text="Tên hộ gia đình/hợp tác xã cung cấp: Ông Phạm Văn Đoan"
                delay={50}
                duration={0.6}
                ease="ease-out"
                splitType="chars"
          ...
          <Box sx={{ width: 'max-content' }}>
            ...
            >
              <SplitText
                text="Quy trình: VietGAP, không sử dụng thuốc trừ sâu bị cắm:"
                delay={50}
                duration={0.6}
                ease="ease-out"
                splitType="chars"
